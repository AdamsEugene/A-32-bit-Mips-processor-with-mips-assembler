...
HD_PWD='C:/Users/adams/Desktop/Final Year Project/CPU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevelView.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopLevelView.tcl
